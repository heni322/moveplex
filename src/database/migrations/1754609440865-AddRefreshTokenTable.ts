...
export class AddRefreshTokenTable1754609440865 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."rides_paymentstatus_enum" RENAME TO "rides_paymentstatus_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."rides_paymentstatus_enum" AS ENUM('pending', 'processing', 'completed', 'failed', 'refunded', 'cancelled')`,
    );
    await queryRunner.query(`ALTER TABLE "rides" ALTER COLUMN "paymentStatus" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "rides" ALTER COLUMN "paymentStatus" TYPE "public"."rides_paymentstatus_enum" USING "paymentStatus"::"text"::"public"."rides_paymentstatus_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rides" ALTER COLUMN "paymentStatus" SET DEFAULT 'pending'`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_user_type_enum" AS ENUM('rider', 'driver', 'admin')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ride_requests" ALTER COLUMN "surge_multiplier" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ride_requests" ALTER COLUMN "surge_multiplier" SET DEFAULT '1'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ride_requests" ALTER COLUMN "surge_multiplier" SET DEFAULT 1.0`,
    );
    await queryRunner.query(
      `ALTER TABLE "ride_requests" ALTER COLUMN "surge_multiplier" DROP NOT NULL`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."users_user_type_enum_old" AS ENUM('rider', 'driver', 'both')`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ALTER COLUMN "user_type" TYPE "public"."users_user_type_enum_old" USING "user_type"::"text"::"public"."users_user_type_enum_old"`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."rides_paymentstatus_enum_old" AS ENUM('pending', 'completed', 'failed', 'refunded')`,
    );
    await queryRunner.query(`ALTER TABLE "rides" ALTER COLUMN "paymentStatus" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "rides" ALTER COLUMN "paymentStatus" TYPE "public"."rides_paymentstatus_enum_old" USING "paymentStatus"::"text"::"public"."rides_paymentstatus_enum_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rides" ALTER COLUMN "paymentStatus" SET DEFAULT 'pending'`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."rides_paymentstatus_enum_old" RENAME TO "rides_paymentstatus_enum"`,
    );
    await queryRunner.query(
