...
export class InitialMigration1750891154353 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_bd9d15dfc78db62767a2fd2350" ON "ride_tracking" USING GiST ("location") `);
        await queryRunner.query(`CREATE TYPE "public"."payments_payment_method_enum" AS ENUM('cash', 'credit_card', 'debit_card', 'digital_wallet', 'bank_transfer')`);
        await queryRunner.query(`CREATE TYPE "public"."payments_payment_type_enum" AS ENUM('ride_fare', 'tip', 'cancellation_fee', 'refund')`);
        ...
        await queryRunner.query(`CREATE TABLE "ratings_reviews" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "ride_id" uuid NOT NULL, "rated_by_id" uuid NOT NULL, "rated_user_id" uuid NOT NULL, "rating" numeric(2,1) NOT NULL, "review" text, "tags" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7b074af47390c638b415e2f7376" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."rides_ride_type_enum" AS ENUM('economy', 'premium', 'pool')`);
        await queryRunner.query(`CREATE TYPE "public"."rides_status_enum" AS ENUM('requested', 'accepted', 'driver_arriving', 'in_progress', 'completed', 'cancelled')`);
        await queryRunner.query(`CREATE TYPE "public"."rides_paymentstatus_enum" AS ENUM('pending', 'completed', 'failed', 'refunded')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_14548a56b921e600f378f8657a" ON "rides" USING GiST ("pickup_location") `);
        await queryRunner.query(`CREATE INDEX "IDX_47c2fd0e6f809516476b51a544" ON "rides" USING GiST ("destination_location") `);
        await queryRunner.query(`CREATE TYPE "public"."users_user_type_enum" AS ENUM('rider', 'driver', 'both')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."driver_profiles_status_enum" AS ENUM('offline', 'online', 'busy', 'on_trip')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_aa8cb429c830046250258ef2e9" ON "ride_requests" USING GiST ("pickup_location") `);
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum" AS ENUM('ride_request', 'ride_accepted', 'driver_arriving', 'ride_started', 'ride_completed', 'payment_processed', 'rating_request', 'promotion')`);
        ...
        await queryRunner.query(`ALTER TABLE "ride_tracking" ADD CONSTRAINT "FK_9edd0497c0dd7602efa239671de" FOREIGN KEY ("ride_id") REFERENCES "rides"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" ADD CONSTRAINT "FK_ab8f98d6ab110b8657d69dcebd0" FOREIGN KEY ("ride_id") REFERENCES "rides"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ratings_reviews" ADD CONSTRAINT "FK_6efdf3647a0103ec178852905f5" FOREIGN KEY ("ride_id") REFERENCES "rides"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ratings_reviews" ADD CONSTRAINT "FK_ff2b0c521abdea425bf588e6a01" FOREIGN KEY ("rated_by_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ratings_reviews" ADD CONSTRAINT "FK_96b3eeb4ffe20a31736d3b0639e" FOREIGN KEY ("rated_user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "rides" ADD CONSTRAINT "FK_d8ca08acdee36ad9774cbf1c57a" FOREIGN KEY ("rider_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "rides" ADD CONSTRAINT "FK_fb13184768dea9734b022874c6f" FOREIGN KEY ("driver_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "driver_profiles" ADD CONSTRAINT "FK_cec43742cd6dea0e8fcae3e29d8" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "driver_profiles" ADD CONSTRAINT "FK_4fe8dd207c95a17ef5f7c8475f3" FOREIGN KEY ("vehicle_id") REFERENCES "vehicles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notifications" ADD CONSTRAINT "FK_9a8a82462cab47c73d25f49261f" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_9a8a82462cab47c73d25f49261f"`);
        await queryRunner.query(`ALTER TABLE "driver_profiles" DROP CONSTRAINT "FK_4fe8dd207c95a17ef5f7c8475f3"`);
        ...
        await queryRunner.query(`ALTER TABLE "ratings_reviews" DROP CONSTRAINT "FK_96b3eeb4ffe20a31736d3b0639e"`);
        await queryRunner.query(`ALTER TABLE "ratings_reviews" DROP CONSTRAINT "FK_ff2b0c521abdea425bf588e6a01"`);
        await queryRunner.query(`ALTER TABLE "ratings_reviews" DROP CONSTRAINT "FK_6efdf3647a0103ec178852905f5"`);
        await queryRunner.query(`ALTER TABLE "payments" DROP CONSTRAINT "FK_ab8f98d6ab110b8657d69dcebd0"`);
        await queryRunner.query(`ALTER TABLE "payments" DROP CONSTRAINT "FK_427785468fb7d2733f59e7d7d39"`);
        await queryRunner.query(`ALTER TABLE "ride_tracking" DROP CONSTRAINT "FK_9edd0497c0dd7602efa239671de"`);
